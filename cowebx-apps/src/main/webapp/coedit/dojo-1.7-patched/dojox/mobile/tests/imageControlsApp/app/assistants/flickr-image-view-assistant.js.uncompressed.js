...
dojo.getObject("dojox.mobile.tests.imageControlsApp.app.assistants.flickr-image-view-assistant", 1);
...
require(["dojox/mobile/tests/imageControlsApp/app/assistants/flickr-image-view-assistant"]);
