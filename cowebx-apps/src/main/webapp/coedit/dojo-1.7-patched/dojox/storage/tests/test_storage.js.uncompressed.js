...
define(["dojo","dijit","dojox","dojox/storage"], function(dojo, dijit, dojox){
dojo.getObject("dojox.storage.tests.test_storage", 1);
...
require(["dojox/storage/tests/test_storage"]);
