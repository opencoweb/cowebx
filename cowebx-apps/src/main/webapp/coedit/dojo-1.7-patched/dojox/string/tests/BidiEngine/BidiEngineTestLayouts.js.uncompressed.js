...
define(["dojo","dijit","dojox","dojox/string/BidiEngine"], function(dojo, dijit, dojox){
dojo.getObject("dojox.string.tests.BidiEngine.BidiEngineTestLayouts", 1);
...
require(["dojox/string/tests/BidiEngine/BidiEngineTestLayouts"]);
