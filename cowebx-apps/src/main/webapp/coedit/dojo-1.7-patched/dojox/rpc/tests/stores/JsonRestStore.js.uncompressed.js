...
define(["dojo","dijit","dojox","dojox/data/JsonRestStore","dojo/data/api/Read","dojox/rpc/Service"], function(dojo, dijit, dojox){
dojo.getObject("dojox.rpc.tests.stores.JsonRestStore", 1);
...
require(["dojox/rpc/tests/stores/JsonRestStore"]);
