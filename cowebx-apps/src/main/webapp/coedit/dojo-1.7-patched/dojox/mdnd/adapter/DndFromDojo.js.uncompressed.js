...
define(["dojo","dijit","dojox","dojox/mdnd/AreaManager","dojo/dnd/Manager"], function(dojo, dijit, dojox){
dojo.getObject("dojox.mdnd.adapter.DndFromDojo", 1);
...
require(["dojox/mdnd/adapter/DndFromDojo"]);
