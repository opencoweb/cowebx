...
define(["dojo","dijit","dojox","dojox/data/FileStore","dojo/data/api/Read","dojo/data/api/Identity"], function(dojo, dijit, dojox){
dojo.getObject("dojox.data.tests.stores.FileStore", 1);
