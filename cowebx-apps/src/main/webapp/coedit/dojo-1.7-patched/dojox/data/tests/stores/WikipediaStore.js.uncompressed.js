...
define(["dojo","dijit","dojox","dojox/data/WikipediaStore","dojo/data/api/Read","dojo/data/api/Identity"], function(dojo, dijit, dojox){
dojo.getObject("dojox.data.tests.stores.WikipediaStore", 1);
...
require(["dojox/data/tests/stores/WikipediaStore"]);
