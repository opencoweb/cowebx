...
define(["dojo","dijit","dojox","dojox/data/CsvStore","dojo/data/api/Read","dojo/data/api/Identity"], function(dojo, dijit, dojox){
dojo.getObject("dojox.data.tests.stores.CsvStore", 1);
