...
define(["dojo","dijit","dojox","dojox/data/HtmlStore","dojo/data/api/Read","dojo/data/api/Identity"], function(dojo, dijit, dojox){
dojo.getObject("dojox.data.tests.stores.HtmlStore", 1);
...
require(["dojox/data/tests/stores/HtmlStore"]);
