...
define(["dojo","dijit","dojox","dojox/data/FlickrRestStore","dojo/data/api/Read"], function(dojo, dijit, dojox){
dojo.getObject("dojox.data.tests.stores.FlickrRestStore", 1);
...
require(["dojox/data/tests/stores/FlickrRestStore"]);
