...
define(["dojo","dijit","dojox","dojox/data/CsvStore","dojo/data/util/sorter"], function(dojo, dijit, dojox){
dojo.getObject("dojox.data.tests.performance.CsvStore", 1);
...
require(["dojox/data/tests/performance/CsvStore"]);
