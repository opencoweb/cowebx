...
define(["dojo","dijit","dojox","dojox/data/HtmlTableStore","dojo/data/api/Read","dojo/data/api/Identity"], function(dojo, dijit, dojox){
dojo.getObject("dojox.data.tests.stores.HtmlTableStore", 1);
...
require(["dojox/data/tests/stores/HtmlTableStore"]);
