...
define(["dojo","dijit","dojox","dojox/data/GoogleSearchStore","dojo/data/api/Read"], function(dojo, dijit, dojox){
dojo.getObject("dojox.data.tests.stores.GoogleSearchStore", 1);
...
require(["dojox/data/tests/stores/GoogleSearchStore"]);
