...
define(["dojo","dijit","dojox","dojox/data/KeyValueStore","dojo/data/api/Read","dojo/data/api/Identity"], function(dojo, dijit, dojox){
dojo.getObject("dojox.data.tests.stores.KeyValueStore", 1);
