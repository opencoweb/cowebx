...
define(["dojo","dijit","dojox","dojo/data/ItemFileReadStore"], function(dojo, dijit, dojox){
dojo.getObject("dojox.data.demos.stores.LazyLoadJSIStore", 1);
...
require(["dojox/data/demos/stores/LazyLoadJSIStore"]);
