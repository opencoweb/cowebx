...
define(["dojo","dijit","dojox","dojox/data/CssClassStore","dojo/data/api/Read","dojo/data/api/Identity"], function(dojo, dijit, dojox){
dojo.getObject("dojox.data.tests.stores.CssClassStore", 1);
...
require(["dojox/data/tests/stores/CssClassStore"]);
