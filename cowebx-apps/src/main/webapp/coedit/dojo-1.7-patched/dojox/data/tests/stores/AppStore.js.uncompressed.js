...
define(["dojo","dijit","dojox","dojox/data/AppStore","dojo/data/api/Read","dojo/data/api/Write","dojo/data/api/Identity"], function(dojo, dijit, dojox){
dojo.getObject("dojox.data.tests.stores.AppStore", 1);
