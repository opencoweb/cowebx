...
define(["dojo","dijit","dojox","dojox/dtl","dojox/dtl/Context","dojox/dtl/utils/date","dojox/date/php","dojox/string/sprintf"], function(dojo, dijit, dojox){
dojo.getObject("dojox.dtl.tests.text.filter", 1);
