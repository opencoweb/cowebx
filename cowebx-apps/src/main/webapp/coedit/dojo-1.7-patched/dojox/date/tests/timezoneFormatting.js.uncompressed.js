...
define(["dojo","dijit","dojox","dojox/date/timezone","dojo/date","dojo/i18n","dojo/cldr/nls/gregorian"], function(dojo, dijit, dojox){
dojo.getObject("dojox.date.tests.timezoneFormatting", 1);
	...
	[
		{
			...
			runTest: function(t){
				...
				// Paris (in fr-fr)
				doh.is("vendredi 11 ao?t 2006 02:55:12 CEST", dojo.date.locale.format(date, {formatLength:'full',locale:'fr-fr',timezone:'Europe/Paris'}));
				// Vienna (in de-at)
...
require(["dojox/date/tests/timezoneFormatting"]);
