...
define(["dojo","dijit","dojox","dojox/date/islamic/Date","dojox/date/islamic/locale","dojox/date/islamic","dojo/date","dojo/date/locale","dojo/i18n","dojo/cldr/nls/gregorian","dojo/i18n","dojo/cldr/nls/islamic","dojo/i18n","dojo/cldr/nls/islamic"], function(dojo, dijit, dojox){
dojo.getObject("dojox.date.tests.islamic.Date", 1);
...
require(["dojox/date/tests/islamic/Date"]);
