...
define(["dojo","dijit","dojox","dojox/mvc","dojox/mvc/StatefulModel","dojo/data/ItemFileWriteStore"], function(dojo, dijit, dojox){
dojo.getObject("dojox.mvc.tests.models.LoanWizardModel", 1);
...
require(["dojox/mvc/tests/models/LoanWizardModel"]);
