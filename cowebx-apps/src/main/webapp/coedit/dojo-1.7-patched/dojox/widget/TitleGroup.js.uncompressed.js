...
define(["dojo","dijit","dojox","dijit/_Widget","dijit/TitlePane"], function(dojo, dijit, dojox){
dojo.getObject("dojox.widget.TitleGroup", 1);
...
require(["dojox/widget/TitleGroup"]);
