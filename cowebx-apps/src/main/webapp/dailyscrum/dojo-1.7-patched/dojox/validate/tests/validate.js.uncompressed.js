...
define(["dojo","dijit","dojox","dojo/i18n","dojo/cldr/nls/currency","dojo/i18n","dojo/cldr/nls/number"], function(dojo, dijit, dojox){
dojo.getObject("dojox.validate.tests.validate", 1);
