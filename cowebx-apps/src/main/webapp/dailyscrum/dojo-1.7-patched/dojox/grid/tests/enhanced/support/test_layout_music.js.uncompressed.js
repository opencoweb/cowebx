...
define(["dojo","dijit","dojox","dijit/form/DateTextBox"], function(dojo, dijit, dojox){
dojo.getObject("dojox.grid.tests.enhanced.support.test_layout_music", 1);
...
require(["dojox/grid/tests/enhanced/support/test_layout_music"]);
