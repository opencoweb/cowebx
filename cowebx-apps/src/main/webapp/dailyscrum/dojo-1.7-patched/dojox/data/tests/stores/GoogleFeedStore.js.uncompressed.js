...
define(["dojo","dijit","dojox","dojox/data/GoogleFeedStore","dojo/data/api/Read"], function(dojo, dijit, dojox){
dojo.getObject("dojox.data.tests.stores.GoogleFeedStore", 1);
...
require(["dojox/data/tests/stores/GoogleFeedStore"]);
