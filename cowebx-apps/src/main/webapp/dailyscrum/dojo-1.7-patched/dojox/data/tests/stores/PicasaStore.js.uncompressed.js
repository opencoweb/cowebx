...
define(["dojo","dijit","dojox","dojox/data/PicasaStore","dojo/data/api/Read"], function(dojo, dijit, dojox){
dojo.getObject("dojox.data.tests.stores.PicasaStore", 1);
...
require(["dojox/data/tests/stores/PicasaStore"]);
