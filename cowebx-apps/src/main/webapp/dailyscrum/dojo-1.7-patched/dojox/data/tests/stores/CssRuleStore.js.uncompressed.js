...
define(["dojo","dijit","dojox","dojox/data/CssRuleStore","dojo/data/api/Read","dojo/data/api/Identity"], function(dojo, dijit, dojox){
dojo.getObject("dojox.data.tests.stores.CssRuleStore", 1);
...
require(["dojox/data/tests/stores/CssRuleStore"]);
