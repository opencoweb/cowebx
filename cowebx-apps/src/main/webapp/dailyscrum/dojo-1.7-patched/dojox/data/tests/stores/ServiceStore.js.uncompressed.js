...
define(["dojo","dijit","dojox","dojox/rpc/Service","dojox/rpc/Rest","dojox/data/ServiceStore","dojo/data/api/Read"], function(dojo, dijit, dojox){
dojo.getObject("dojox.data.tests.stores.ServiceStore", 1);
...
require(["dojox/data/tests/stores/ServiceStore"]);
