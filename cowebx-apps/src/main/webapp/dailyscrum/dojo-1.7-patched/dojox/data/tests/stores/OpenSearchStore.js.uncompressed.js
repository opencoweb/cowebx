...
define(["dojo","dijit","dojox","dojox/data/OpenSearchStore","dojo/data/api/Read"], function(dojo, dijit, dojox){
dojo.getObject("dojox.data.tests.stores.OpenSearchStore", 1);
...
require(["dojox/data/tests/stores/OpenSearchStore"]);
