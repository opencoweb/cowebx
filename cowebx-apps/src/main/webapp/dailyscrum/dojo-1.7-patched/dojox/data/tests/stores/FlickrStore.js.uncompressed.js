...
define(["dojo","dijit","dojox","dojox/data/FlickrStore","dojo/data/api/Read"], function(dojo, dijit, dojox){
dojo.getObject("dojox.data.tests.stores.FlickrStore", 1);
...
require(["dojox/data/tests/stores/FlickrStore"]);
