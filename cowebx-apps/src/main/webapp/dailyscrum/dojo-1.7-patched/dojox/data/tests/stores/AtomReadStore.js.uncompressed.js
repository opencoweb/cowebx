...
define(["dojo","dijit","dojox","dojox/data/AtomReadStore","dojo/data/api/Read"], function(dojo, dijit, dojox){
dojo.getObject("dojox.data.tests.stores.AtomReadStore", 1);
...
require(["dojox/data/tests/stores/AtomReadStore"]);
