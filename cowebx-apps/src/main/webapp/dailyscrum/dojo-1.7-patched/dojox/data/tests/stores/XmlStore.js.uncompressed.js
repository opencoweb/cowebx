...
define(["dojo","dijit","dojox","dojox/data/XmlStore","dojo/data/api/Read","dojo/data/api/Write","dojo/data/api/Identity"], function(dojo, dijit, dojox){
dojo.getObject("dojox.data.tests.stores.XmlStore", 1);
...
require(["dojox/data/tests/stores/XmlStore"]);
