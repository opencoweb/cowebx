...
define(["dojo","dijit","dojox","dojox/rpc/Service","dojox/data/JsonRestStore","dojox/json/schema","dojo/data/api/Read","dojo/data/ItemFileReadStore"], function(dojo, dijit, dojox){
dojo.getObject("dojox.data.tests.stores.JsonRestStore", 1);
...
require(["dojox/data/tests/stores/JsonRestStore"]);
