...
define(["dojo","dijit","dojox","dojox/data/OpmlStore","dojo/data/api/Read","dojo/data/api/Identity"], function(dojo, dijit, dojox){
dojo.getObject("dojox.data.tests.stores.OpmlStore", 1);
...
require(["dojox/data/tests/stores/OpmlStore"]);
