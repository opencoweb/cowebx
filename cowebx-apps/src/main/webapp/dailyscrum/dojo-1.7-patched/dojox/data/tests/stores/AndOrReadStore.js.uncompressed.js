...
define(["dojo","dijit","dojox","dojox/data/AndOrReadStore","dojo/data/api/Read","dojo/data/api/Identity","dojo/date","dojo/date/stamp"], function(dojo, dijit, dojox){
dojo.getObject("dojox.data.tests.stores.AndOrReadStore", 1);
