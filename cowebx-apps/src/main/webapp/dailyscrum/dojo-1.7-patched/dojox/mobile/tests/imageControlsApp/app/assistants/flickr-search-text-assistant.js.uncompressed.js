...
dojo.getObject("dojox.mobile.tests.imageControlsApp.app.assistants.flickr-search-text-assistant", 1);
...
require(["dojox/mobile/tests/imageControlsApp/app/assistants/flickr-search-text-assistant"]);
