...
define(["dojo","dijit","dojox","dojox/json/query","dojox/jsonPath"], function(dojo, dijit, dojox){
dojo.getObject("dojox.json.tests.query", 1);
...
require(["dojox/json/tests/query"]);
