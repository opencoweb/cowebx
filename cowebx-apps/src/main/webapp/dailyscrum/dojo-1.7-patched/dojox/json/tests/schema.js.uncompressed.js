...
define(["dojo","dijit","dojox","dojox/json/schema","dojox/json/ref"], function(dojo, dijit, dojox){
dojo.getObject("dojox.json.tests.schema", 1);
...
require(["dojox/json/tests/schema"]);
