...
define(["dojo","dijit","dojox","dojox/secure/fromJson"], function(dojo, dijit, dojox){
dojo.getObject("dojox.secure.tests.fromJson", 1);
...
require(["dojox/secure/tests/fromJson"]);
