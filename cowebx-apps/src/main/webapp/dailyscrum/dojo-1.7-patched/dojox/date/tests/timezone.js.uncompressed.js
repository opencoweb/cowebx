...
define(["dojo","dijit","dojox","dojox/date/timezone","dojo/date"], function(dojo, dijit, dojox){
dojo.getObject("dojox.date.tests.timezone", 1);
...
require(["dojox/date/tests/timezone"]);
