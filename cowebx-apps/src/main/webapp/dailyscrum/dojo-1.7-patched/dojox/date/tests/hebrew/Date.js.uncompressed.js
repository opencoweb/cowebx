...
define(["dojo","dijit","dojox","dojox/date/hebrew","dojox/date/hebrew/Date","dojox/date/hebrew/locale","dojo/date/locale","dojo/i18n","dojo/cldr/nls/gregorian","dojo/i18n","dojo/cldr/nls/hebrew","dojo/i18n","dojo/cldr/nls/gregorian","dojo/i18n","dojo/cldr/nls/hebrew"], function(dojo, dijit, dojox){
dojo.getObject("dojox.date.tests.hebrew.Date", 1);
...
require(["dojox/date/tests/hebrew/Date"]);
