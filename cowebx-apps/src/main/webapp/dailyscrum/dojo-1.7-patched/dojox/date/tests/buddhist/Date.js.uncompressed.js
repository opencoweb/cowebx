...
define(["dojo","dijit","dojox","dojox/date/buddhist","dojox/date/buddhist/Date","dojox/date/buddhist/locale","dojo/date/locale","dojo/i18n","dojo/cldr/nls/gregorian","dojo/i18n","dojo/cldr/nls/buddhist"], function(dojo, dijit, dojox){
dojo.getObject("dojox.date.tests.buddhist.Date", 1);
...
require(["dojox/date/tests/buddhist/Date"]);
