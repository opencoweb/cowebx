...
define(["dojo","dijit","dojox","dojox/dtl/dom","dojox/dtl/render/dom","dojox/string/Builder"], function(dojo, dijit, dojox){
dojo.getObject("dojox.dtl.tests.dom.util", 1);
...
require(["dojox/dtl/tests/dom/util"]);
