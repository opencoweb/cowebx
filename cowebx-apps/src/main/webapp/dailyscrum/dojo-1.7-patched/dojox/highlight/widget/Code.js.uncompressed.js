...
define(["dojo","dijit","dojox","dijit/_Widget","dijit/_Templated","dojox/highlight"], function(dojo, dijit, dojox){
dojo.getObject("dojox.highlight.widget.Code", 1);
...
require(["dojox/highlight/widget/Code"]);
